...
const Parallax = ({type}) => {
  ...
  return (
      <div
          ...
          ref={ref}
          style={{
            background: type === 'services' ? "linear-gradient(180deg, #0c0c1d, #111132)" : "linear-gradient(180deg, #111132, #505064)",
          }}
      >
        <motion.h1 style={{y: yText}}>
          {type === 'services' ? 'My Professional Experience' : 'My Projects'}
        </motion.h1>
        <motion.div className="mountains"></motion.div>
        <motion.div
            className="planets"
